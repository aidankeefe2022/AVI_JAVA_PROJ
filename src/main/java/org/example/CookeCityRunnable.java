...
public class CookeCityRunnable implements Runnable {
    static DB db;
    static String URL;
    static String Table;

    public CookeCityRunnable(){
        CookeCityRunnable.Table = "CookeCity";
        CookeCityRunnable.URL ="https://www.mtavalanche.com/forecast/cooke-city";
        CookeCityRunnable.db = new DB();
