...
public class BridgerRunnable implements Runnable {
    static DB db;
    static String URL;
    static String Table;

    public BridgerRunnable(){
        BridgerRunnable.Table = "Bridger";
        BridgerRunnable.URL = "https://www.mtavalanche.com/forecast/bridgers";
        BridgerRunnable.db = new DB();

    }

    @Override
    public void run() {
        insertNewData(BridgerRunnable.URL,BridgerRunnable.Table);
    }
