...
public class NorthernGallatinsRunnable implements Runnable{
    static DB db;
    static String URL;
    static String Table;

    public NorthernGallatinsRunnable(){
        NorthernGallatinsRunnable.Table = "NorthernGallatins";
        NorthernGallatinsRunnable.URL ="https://www.mtavalanche.com/forecast/northern-gallatin";
        NorthernGallatinsRunnable.db = new DB();
